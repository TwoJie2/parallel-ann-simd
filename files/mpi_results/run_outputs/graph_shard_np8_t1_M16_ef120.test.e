...
MPI ANN run: algorithm=mpi_hnsw_shard np=8 threads=1 base=100000 query=2000 dim=96 nlist=128 nprobe=32 M=16 efC=100 ef=120 parts_per_rank=4 router_probe=16
