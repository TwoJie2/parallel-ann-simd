...
MPI ANN run: algorithm=mpi_ivf_hnsw_omp np=8 threads=2 base=100000 query=2000 dim=96 nlist=128 nprobe=16 M=16 efC=100 ef=80 parts_per_rank=4 router_probe=16
